...
The goal of `tgc` is to facilitate application of the Thermal Growth Coefficient (TGC) model for aquaculture. The package include functions to identify stocked seasons, filter out heat stress observations, apply the TGC model, and visualize results. 
